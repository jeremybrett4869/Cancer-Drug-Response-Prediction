...
# -----------------------------------------------------------------
    ...
    if args.mode == 'train':
        ...
        state_dict_name = f'{rpath}weights_0308/weights_5/weight_sim_seed{args.seed}.pth' if args.sim==True else f'{rpath}weights_0308/weights_5/weight_seed{args.seed}.pth'
